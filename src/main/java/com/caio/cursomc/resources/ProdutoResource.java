...
import com.caio.cursomc.resources.utils.URL;
import com.caio.cursomc.services.ProdutoService;

@RestController
@RequestMapping(value="/produtos") //mapeamento
public class ProdutoResource {
	...
	public ResponseEntity<Produto> find(@PathVariable Integer id) { //Método para utilizar o serviço que
