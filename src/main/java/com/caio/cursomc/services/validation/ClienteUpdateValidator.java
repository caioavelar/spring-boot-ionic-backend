...
public class ClienteUpdateValidator implements ConstraintValidator<ClienteUpdate, ClienteDTO> {
	...
	public boolean isValid(ClienteDTO objDto, ConstraintValidatorContext context) {
		...
		Map<String, String> map = (Map<String, String>) request.getAttribute(HandlerMapping.URI_TEMPLATE_VARIABLES_ATTRIBUTE); //Necessário
		Integer uriId = Integer.parseInt(map.get("id"));																	//Paga obter
		List<FieldMessage> list = new ArrayList<>(); 																		//O valor da 
																															//URI
