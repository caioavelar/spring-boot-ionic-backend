...
import com.caio.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		categoriaRepository.saveAll(Arrays.asList(cat1,cat2,cat3,cat4,cat5,cat6,cat7)); //Salvar todos os valores, como array, no banco
		...
		Cliente cli1 = new Cliente(null,"Maria Silva", "caioacorp@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		cli1.getTelefone().addAll(Arrays.asList("27363323","93838393"));
		
		
		Cliente cli2 = new Cliente(null,"Ana Costa", "cabo2master3@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		ItemPedido ip2 = new ItemPedido(ped1, p3, 0, 3, 80);
